...
const CheckOut = () => {
  ...
  const onSubmit = (data) => {
    ...
    data.status = "pending";
    fetch("https://power-tools-server.vercel.app/orders", {
      method: "POST",
    ...
    <div className="p-20">
      <div className="grid grid-cols-6 gap-5">
        <div className="puchase-info-form col-start-2 col-span-4">
          <h2 className="text-3xl capitalize mb-10 text-center mt-10 lg:mt-0">
            Fill up the form to buy
          </h2>
          <form onSubmit={handleSubmit(onSubmit)}>
            <input
              className="border-b-2 w-full border- pl-5 mb-5 rounded-full py-3 outline-none"
            ...
            errors.city ||
            errors.phone ? (
              <span className="text-red-500 font-semibold  pl-5 mb-3">
            ...
            <input
              className="border-2 border-secondary px-14 text-lg cursor-pointer rounded-full bg-white mx-auto block py-2 mt-3"
              type="submit"
              value="Continue Payment"
            />
          </form>
          <div>
            <p className="text-red-500 mt-10 px-10">
              {" "}
