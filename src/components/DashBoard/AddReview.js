  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <input
          className="border-b-2 w-2/3 border-secondary pl-5 mb-5 rounded-full py-3 outline-none"
          type="name"
            ...
            return (
              <label key={i}>
                ...
                <FaStar
                  ...
                  className="star inline-block text-4xl"
        ...
        <textarea
          className="border-2 mt-5 rounded-full w-2/3 border-secondary pl-5 mb-5 py-3 outline-none"
          {...register("Review")}
        />{" "}
        <br />
        <input
        ...
        <button
          type="submit"
          className="btn border-2 border-secondary rounded-full bg-white text-black px-10"
        >
          Submit Rating
        </button>
      </form>
